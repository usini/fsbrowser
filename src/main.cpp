...
String default_ssid = "espespesp";
String default_password = "espespesp";
...
void processSSID()
{
  String command = commandProcessor(); 
  NVS.setString("ssid", String(command));
  Serial.print("SSID is: ");
  Serial.println(NVS.getString("ssid"));
}

void processPASSWORD()
{
  String command = commandProcessor(); 
  NVS.setString("password", String(command));
  Serial.print("PASSWORD is: ");
  Serial.println(NVS.getString("password"));
}
...
void setup(void)
{
  ...
  sCmd.addCommand("ssid:", processSSID);
  sCmd.addCommand("password:", processPASSWORD);
